...
function createPickupTab()
    ...
    local pickupToggles = {
        Adurite = {"Raw Adurite", "Adurite Bar"},
        ...
        Emerald = {"Emerald"},
        Essence = {"Essence"},
        Gold = {"Big Gold Bar", "Raw Gold", "Gold Bar"},
        Heartfruit = {"Heartfruit"},
        Hellstone = {"Raw Hellstone", "Hellstone Bar"},
        IceCube = {"Ice Cube"},
        Iron = {"Raw Iron", "Iron Bar"},
